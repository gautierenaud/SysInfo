...
FSOURCE = source.lex
FINTESRC= inter.lex
INCSRC	= symbols.h tableSymbols.h tableFonctions.h tableInstructions.h utils.h
INCINTE = symbols.h tableSymbols.h tableFonctions.h exprTree.h
CSRC	= y.tab.c lex.yy.c tableSymbols.c tableFonctions.c tableInstructions.c utils.c
